...
Live path uses MediaPipe Pose Landmarker in the browser. Landmarks drive limb ratios and coaching sentences mapped to PRSUT scales (box squat, dowel hinge, landmine press, 9 a.m. class).
